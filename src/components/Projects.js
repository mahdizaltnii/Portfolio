...
const Projects = ({ darkMode ,toggleDarkMode}) => {
  ...
  return (
    ...
    <section className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white px-5 py-32 font-mono" id="projects">
      <div className="container mx-auto grid md:grid-cols-2 items-center md:justify-between">
        <div className="about-info mb-5">
          ...
          <p className="pb-5">
            These are some of my best projects. I have built these with VueJs,Angular
            Java SpringBoot,NodeJs and Tailwind CSS. Check them out.
          </p>
        </div>
